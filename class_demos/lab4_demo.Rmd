...
Can either do the recipe before splitting the data and then prep and bake on original data. Or split first and then recipe, prep, and bake on the training / test data separately. 

If transforming, transform before you encode. 

Split, then transform, then encode!
...
#either of the below methods work 
...
#someone who works overtime is almost 4 times as likely to quit than someone who doesn't work overtime
